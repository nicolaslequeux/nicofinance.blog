    ...
    return(
      ...
      <Layout>
        ...
        <Container style={{ maxWidth: "700px", margin: "auto" }}>
          ...
          <h2 className="text-center pt-4 pb-3">Vigilant Asset Allocation</h2>
          <p className="text-center">Feuille de calcul Google Sheet - Performances</p>
          ...
          {/* <h5 className="text-center p-3">Résumé de la stratégie VAA</h5> */}
