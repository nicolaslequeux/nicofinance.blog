...
export default ({ data }) => (
  ...
  <Layout>
    ...
    <Container style={{ maxWidth: "700px", margin: "auto" }}>
      ...
      <p className="text-justify">J'ai créé ce blog pour partager mes connaissances et mon expérience personnelle, pour qui voudrait prendre en main son autonomie financière. C'est à dire, ne plus dépendre exclusivement d'un salaire mensuel, pour maintenir son niveau de vie et avoir plus de temps à lui pour profiter de la vie. La condition du succès repose sur la constitution d'une épargne financière, qui va permettre au fils du temps, de générer suffisamment d'intérêts pour couvrir les dépenses.</p>
